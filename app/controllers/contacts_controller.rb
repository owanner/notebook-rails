class ContactsController < ApplicationController
  ...
  before_action :set_options_for_select, only: [:create, :new, :edit, :update]
  #http_basic_authenticate_with name:"wanner", password: "secret", only: :destroy
  ...
  private
    ...
    def contact_params
      params.require(:contact).permit(:name, :email, :kind_id, :rmk,
        ...
        phones_attributes: [:id, :phone, :_desrtoy])
    end
end
